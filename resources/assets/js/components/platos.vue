    ...
    <div class="container-fluid">
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i>Plato
          <button
            type="button"
            ...
            >
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  ...
                  />
                  <span class="help-block">(*) Ingrese el nombre del Plato</span>
                </div>
              </div>
            </form>
          </div>
          <div class="modal-body">
            ...
            >
              <div class="form-group row">
                ...
                >
                <div class="col-md-9">
                  <input type="text" v-model="costo" id="telefono" name="telefono" class="form-control" placeholder="ingrese el costo del plato "/>
                  <span class="help-block">(*) Ingrese Costo del plato</span>
                </div>
              </div>
            </form>
          </div>
          <div class="modal-body">
            ...
            >
              <div class="form-group row">
                ...
                >
                <div class="col-md-9">
                  <input type="text" v-model="cantidad" id="direccion" name="direccion" class="form-control" placeholder="ingrese la cantidad del Plato "/>
                  <span class="help-block">(*) Ingrese cantidad del Plato</span>
                </div>
              </div>
            </form>
          </div>
    ...
    >
      <div class="modal-dialog modal-danger" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Estas seguro de eliminar Plato?</p>
          </div>
          <div class="modal-footer">
            <button
              type="button"
